...
function test_scripts() {
	wp_enqueue_style( 'bs', 'https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css', false, '4.3.1', 'all' );
	...
	wp_enqueue_script( 'bs', 'https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js', array('popper'), '4.3.1', 'true');
...
register_sidebar( array(
	'name' => 'Footer колонка №3',
	'id' => 'footer-column-3',
	'description' => '' ,
	'before_widget' => '<a href="tel:+17003254245" class="footer-number">',
	'after_widget' => '</a>',
	'before_title' => '<h2>',
	'after_title' => '</h2>',
) );